...
Renderer::Renderer(int width, int height, float near, float far, float fogDensity, float fogGradient, float terrainSize,
...
void Renderer::renderScene(const glm::mat4 &view, const glm::mat4 &proj, const LightCollection &lights,
...
void Renderer::update(float deltatime) { m_skyRenderer->rotate(deltatime); }
